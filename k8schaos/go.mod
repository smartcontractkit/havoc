module github.com/smartcontractkit/havoc/k8schaos
...
replace (
	...
	github.com/smartcontractkit/chainlink-testing-framework/grafana => /Users/lukasz/Documents/smartcontractkit/chainlink-testing-framework/grafana
)
