...
type SingleLineGrafanaAnvilChaosAnnotator struct {
	client       *grafana.Client
	dashboardUID string
	logger       zerolog.Logger
}

func NewSingleLineGrafanaAnvilChaosAnnotator(grafanaURL, grafanaToken, dashboardUID string, logger zerolog.Logger) *SingleLineGrafanaAnnotator {
...
func (l SingleLineGrafanaAnvilChaosAnnotator) OnChaosCreated(chaos AnvilChaos) {
}

func (l SingleLineGrafanaAnvilChaosAnnotator) OnChaosCreationFailed(chaos AnvilChaos, reason error) {
}

func (l SingleLineGrafanaAnvilChaosAnnotator) OnChaosStarted(chaos AnvilChaos) {
...
func (l SingleLineGrafanaAnvilChaosAnnotator) OnChaosPaused(chaos AnvilChaos) {
}

func (l SingleLineGrafanaAnvilChaosAnnotator) OnChaosEnded(chaos AnvilChaos) {
	// experiment, _ := chaos.GetExperimentStatus()
	// duration, _ := chaos.GetChaosDuration()
...
func (l SingleLineGrafanaAnvilChaosAnnotator) OnChaosStatusUnknown(chaos AnvilChaos) {
}

func (l SingleLineGrafanaAnvilChaosAnnotator) OnScheduleCreated(s Schedule) {
	var sb strings.Builder
	sb.WriteString("<body>")
...
func (l SingleLineGrafanaAnvilChaosAnnotator) OnScheduleDeleted(s Schedule) {
	var sb strings.Builder
	sb.WriteString("<body>")
